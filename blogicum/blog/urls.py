...
from . import views
from .views import ProfileView, ProfileUpdateView, PostCreateView, add_comment, PostUpdateView, PostDeleteView, CommentUpdateView, CommentDeleteView
...
urlpatterns = [
    ...
    path('posts/<int:post_id>/edit_comment/<int:pk>', CommentUpdateView.as_view(), name='edit_comment'),
